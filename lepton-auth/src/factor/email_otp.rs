...
pub(super) async fn issue(
    ...
    let email = if let Some(existing) = AccountEmail::query(valence, valence::use_!(r"In **factor**, we **list Account Email** so the product can show or process the matching set for this workflow. Callers allowed for **factor** use the list; it is not a public dump of every field to anonymous visitors."))
